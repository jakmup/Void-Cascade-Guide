...
var require_simpleLightbox = __commonJS({
  "node_modules/simple-lightbox/src/simpleLightbox.js"(exports, module) {
    (function(root, factory) {
      ...
      assign(SimpleLightbox.prototype, {
        init: function(options) {
          ...
          if (options.elements) {
            elements = [].slice.call(
              typeof options.elements === "string" ? document.querySelectorAll(options.elements) : options.elements
            );
          }
...
export default require_simpleLightbox();
